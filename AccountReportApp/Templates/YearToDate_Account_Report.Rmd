...
# Extract out transfers, if present, because this is not an expense
memberDrawTotal <- dplyr::filter(spendTotal, ExpClass == "Member Draw")
transferTotal <- dplyr::filter(spendTotal, ExpClass %in% c("Transfer"))
spendTotal <- dplyr::filter(spendTotal, !ExpClass %in% c("Member Draw", "Transfer"))
